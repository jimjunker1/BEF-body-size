...
b_s_pred_plot = b_s_pred %>% 
  ...
  geom_point(data = dw_dat_summ, aes(x = log(hill_0), y = lb_m2, fill = site_id), shape = 21, color = 'black', alpha = 0.5, position = position_jitter(width = 0.02))+
...
b_m_pred_plot = b_m_pred %>% 
  ...
  geom_point(data = dw_dat_summ, aes(x = lmbar_b_met, y = lb_m2, fill = site_id), shape = 21, color = 'black', alpha = 0.5, position = position_jitter(width = 0.02))+
...
dw_dat_summ %>% 
  ggplot()+
  geom_point(aes(x = lmbar_b_met_s, y = ln_tot_s, fill = site_id),shape = 21, color = 'black', alpha = 0.5)+
  geom_point(data = dw_dat_summ %>% summarise(lmbar_b_met_s = mean(lmbar_b_met_s, na.rm = TRUE), 
                                              ln_tot_s = mean(ln_tot_s, na.rm = TRUE), .by = 'site_id'), aes(x = lmbar_b_met_s, y = ln_tot_s, fill = site_id), color = 'black', shape = 21, size = 3)+
  scale_fill_viridis(discrete = TRUE)+
...
NM_met_bwt_pred %>% 
  ggplot()+
  geom_line(aes(x = lmbar_b_met_s, y = pred))+
  geom_point(aes(x = lmbar_b_met_s, y = ln_tot_s))

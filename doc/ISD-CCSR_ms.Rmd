...
dw_dat_summ %>%
  ggplot()+
  geom_point(aes(x = hill_0, y = lb_m2, color = site_id))+
...
b_s_pred_plot = b_s_pred %>% 
  ...
  annotate('text', x = -Inf, y = Inf, vjust = 1, hjust = 0, parse = TRUE, label = s_text_annotation )+
...
b_m_pred_plot = b_m_pred %>% 
  ...
  scale_fill_viridis(discrete = TRUE)+
  annotate('text', x = -Inf, y = Inf, vjust = 1, hjust = 0, parse = TRUE, label = m_text_annotation )+

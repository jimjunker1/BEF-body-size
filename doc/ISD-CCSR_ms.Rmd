...
#                          lb_m2 = mean(lb_m2, na.rm = TRUE), .by = 'site_id'), aes(y = lb_m2, x = lmbar_b, color = site_id), size = 4)+ 
...
b_s_pred_plot = b_s_pred %>% 
  ...
  geom_point(data = dw_dat_summ %>% summarise(hill_0 = mean(hill_0),
             ...
             aes(x = log(hill_0), y = lb_m2, fill = site_id), color = 'black', shape = 21, size = 4)+
...
b_m_pred_plot = b_m_pred %>% 
  ...
  geom_point(data = dw_dat_summ %>% summarise(lmbar_b_met = mean(lmbar_b_met),
                                              lb_m2 = mean(lb_m2, na.rm = TRUE),.by = 'site_id'),
             aes(x = lmbar_b_met, y = lb_m2, fill = site_id), color = 'black', shape = 21, size = 4)+
...
dw_dat_summ %>% 
  ...
  geom_point(data = dw_dat_summ %>% summarise(lmbar_b_met = mean(lmbar_b_met, na.rm = TRUE), 
                                              ln_tot = mean(ln_tot, na.rm = TRUE), .by = 'site_id'), aes(x = lmbar_b_met, y = ln_tot, fill = site_id), color = 'black', shape = 21, size = 4)+
...
b_lambda_pred_plot = b_m_marg %>% 
  ...
  lb_m2 = mean(lb_m2, na.rm = TRUE),.by = 'site_id'),
  aes(x = lambda_med, y = lb_m2, fill = site_id), color = 'black', shape = 21, size = 4)+
...
#              aes(x = lambda_med, y = .residual_med, fill = site_id), color = 'black', shape = 21, size = 4)+
#   scale_fill_viridis(discrete = TRUE)+
...
dat %>% 
  ...
  geom_point(data = dat %>% summarise(lmbar_n_est_met = mean(lmbar_n_est_met),
                                      ln_est = mean(ln_est),
                                      ,.by = 'site_id'),
             aes(x = lmbar_n_est_met, y = ln_est, fill = site_id), shape = 22, size = 4)+
  geom_point(data = dat %>% summarise(lmbar_n_met = mean(lmbar_n_met),
                                      ln_tot = mean(ln_tot), .by = 'site_id'), aes(x = lmbar_n_met, y = ln_tot, fill = site_id), shape = 21, size = 4)+
  ...
  scale_y_continuous(name = expression("Abundance (individuals    "~m^-2~")"),
                     ...
                     limits = c(0,27))+
  scale_fill_viridis(discrete = TRUE)+
  theme(legend.position = 'none');n_m_extrapolate_plot 
...
NM_met_bwt_pred %>%
  ...
  geom_point(data = . %>% summarise(hill_0 = mean(hill_0, na.rm = TRUE),
             ...
             aes(x = log(hill_0), resid_theory, fill = site_id), color = 'black', shape = 21, size = 4)+
  scale_fill_viridis(discrete = TRUE)+
  theme(legend.position = 'none')
